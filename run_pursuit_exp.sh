...
python pursuit.py -m mlp  --num_evaders 60 --num_pursuers 8 --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb
python pursuit.py -m gat  --num_evaders 60 --num_pursuers 8 --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb

python pursuit.py -m mlp  --num_evaders 60 --num_pursuers 8 --env_size 32 --obs_range 16 --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb
python pursuit.py -m gat  --num_evaders 60 --num_pursuers 8 --env_size 32 --obs_range 16 --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb

python pursuit.py -m mlp  --num_evaders 60 --num_pursuers 8 --env_size 32  --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb
python pursuit.py -m gat  --num_evaders 60 --num_pursuers 8 --env_size 32  --train_batch_size 5000 --lr 0.0001 --batch_mode truncate_episodes --num_workers 3 --use_wandb
